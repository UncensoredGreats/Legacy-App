/*
Tldr: This file defines a context for card state and a provider for the context. It also defines a hook to access the context.
So it manages card state and includes functions to manipulate the card state.
