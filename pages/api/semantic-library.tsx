...
// // First attempt at using the flask version.
...
//         // Extract author IDs and categories from AUTHOR_INFO for new Flask logic
//         const authorsData = AUTHOR_INFO.map(author => ({
//             name: author.id,
...
//             authors: authorsData
//         };
//         console.log("Sending payload to Flask:", JSON.stringify(payload, null, 2));  // Pretty print the payload for better readability
...
//         const response = await fetch('https://extractivesummarizer-77f3c3288124.herokuapp.com/related-authors', {
//             method: 'POST',
...
//         const relatedAuthorsFromFlask = data.related_authors;

//         // Modify logic to get author info
//         let relatedAuthors = authorId ? [AUTHOR_INFO.find(a => a.id === authorId)?.cluster] : relatedAuthorsFromFlask;
